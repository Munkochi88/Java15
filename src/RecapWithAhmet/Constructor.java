...
public class Constructor {
    ...
    1-What is constructor and what do you do with it?
        -->It is way to initialize instance variables.
        -->it is a way to assign value for object features.

    2-Can you tel me the difference between constructor and method?
        CONSTRUCTOR:                            METHODS:
    ...
    3-Can you make constructor static,final and private?
        UI --> SINGLETON PATTERN DESIGN --> WE USE CONSTRUCTOR PRIVATE TO PREVENT
        OTHER CLASSES TO ACCESS THE DRIVER.
