...
public class Practice3 {
    public static void main(String[] args) {
        ...
        ArrayList<String> abcd = test(zipCodes);
    ...
    // create a method that will take an ArrayList<Integer> as parameter
    // it will generate message for each item from the list
    // it will store and return those messages as an ArrayList

    public static ArrayList<String> test(ArrayList<Integer> list){
