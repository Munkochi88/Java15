...
public class StringMethods1 {
    public static void main(String[] args) {
        ...
        // length(); count number of characters in giving string and return it as int(number)

        int number = str.length(); // 6
        ...
        // want to take last char from given string, but you don't know the index number for last char
